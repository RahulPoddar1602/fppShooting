// SOUNDS
var music1 = new Audio('audio/audio1.mp3');
music1.volume = 0.2;
music1.loop = true;

var myGunshot = new Audio('audio/laser_sound.mp3');
var enemyFalling = new Audio('audio/femaleScream.mp3');
var enemyDie = new Audio('audio/thud.mp3');

var bulletPang = new Audio('audio/bulletPang.mp3');
bulletPang.volume=1;

var fear = new Audio('audio/fear.mp3');
fear.volume=1;
var enemyGunshot = new Audio('audio/burstfire.mp3');
